...
/**
 * Constructs a new Utils object. Utils is meant to be used as a static class,
...
/**
 * @constant {number} PRECISION - number of digits to be used
*                                 in Utils.isPrecisionEqual().
 */
Utils.PRECISION =  1;
 ...
 *
 * It is also true if their difference is less than @see Utils.EPSILON.
 *
 ...
 * @returns {number} - Returns 1 if (x1,y1) is greater than (x2, y2),
 ...
 * @param {number} x - first number.
 * @param {number} y - second number.
 * @returns {boolean} -  True if x and y are equal when rounded up to the number
 ...
 * @returns {string} - Returns an SVG line string.
 *
 */
