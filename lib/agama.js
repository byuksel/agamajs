...
Agama.fromJSON = function(jsonStr, divElem) {
  ...
  var fromStr = JSON.parse(jsonStr);
  var paper =  new Agama(divElem, fromStr.width, fromStr.height);

  var idToElem = {};
  for (var i = 0; i < fromStr.elements.length; i++) {
    var node = fromStr.elements[i];
    var elem;
